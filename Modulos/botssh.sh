...
fun_botOnOff () {
      [[ $(ps x | grep "bot_plus"|grep -v grep | wc -l) = '0' ]] && {
          ...
          clear
          echo -e "\033[1;32mSTARTING SSHPLUS BOT\033[0m\n"
          fun_bot1 () {
          ...
          fun_bar 'fun_bot2'
          echo -e "\n\033[1;32m \033[1;31mSSHPLUS BOT STOPPED! \033[0m"
          sleep 3
          menu
      }
}
...
echo -e "\n\033[1;32m3° \033[1;37m- \033[1;33mBOT \033[1;37m@EdRobot \033[1;33mE GET YOUR ID \033[1;31mOPTION: \033[1;37m/id\033[0m"
