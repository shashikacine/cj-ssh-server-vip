...
for pton in `echo -e "$PT" | cut -d: -f2 | cut -d' ' -f1 | uniq`; do
    ...
    [[ "$porta" = "$pton" ]] && {
    	echo -e "\n\033[1;31mDOOR \033[1;33m$porta \033[1;31mEIN USE BY\033[1;37m$svcs\033[0m"
    	sleep 3
    	fun_conexao
    }
done
...
echo -e "\n\033[1;33mWHICH DOORS DO YOU WANT TO USE IN THE SQUID \033[1;31m?"
echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mSET THE DOORS IN SEQUENCE \033[1;33mEX: \033[1;37m80 8080 8799"
echo ""
echo -ne "\033[1;32mINFORM THE DOORS\033[1;37m: "; read portass
if [[ -z "$portass" ]]; then
...
addpt_sqd () {
	echo -e "\E[44;1;37m        ADD DOOR TO SQUID       \E[0m"
	echo -e "\n\033[1;33mDOORS IN USE: \033[1;32m$sqdp\n"
	...
	echo -ne "\033[1;32mWHICH DOOR YOU WANT TO ADD \033[1;33m?\033[1;37m "; read pt
	if [[ -z "$pt" ]]; then
		echo -e "\n\033[1;31mInvalid door!"
		sleep 3
		clear
	...
	echo -e "\n\033[1;32mSUCCESSFULLY ADDED DOOR!"
	sleep 3
	clear
	fun_squid
}
...
rempt_sqd () {
	echo -e "\E[41;1;37m       REMOVE SQUID DOOR       \E[0m"
	echo -e "\n\033[1;33mDOORS IN USE: \033[1;32m$sqdp\n"
	if [[ -f "/etc/squid/squid.conf" ]]; then
		var_sqd="/etc/squid/squid.conf"
	elif [[ -f "/etc/squid3/squid.conf" ]]; then
	...
	echo -ne "\033[1;32mWHICH DOOR YOU WISH TO REMOVE \033[1;33m?\033[1;37m "; read pt
	if [[ -z "$pt" ]]; then
		echo -e "\n\033[1;31mInvalid door!"
		sleep 2
		clear
	...
	if grep -E "$pt" $var_sqd > /dev/null 2>&1; then
		...
		echo ""
		fun_bar 'service squid restart' 'service squid3 restart'
		echo -e "\n\033[1;32mDOOR SUCCESSFULLY REMOVED!"
		sleep 3.5s
		clear
		fun_squid
	else
		echo -e "\n\033[1;31mDOOR \033[1;32m$pt \033[1;31mNOT FOUND!"
		sleep 3.5s
		clear
		fun_squid
	fi
...
sqdp=$(netstat -nplt |grep 'squid' | awk -F ":" {'print $4'} | xargs)
    echo -e "\n\033[1;33mDOORS\033[1;37m: \033[1;32m$sqdp"
...
[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mADD DOOR \033[1;31m
[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mREMOVE DOOR\033[1;31m
...
fun_drop () {
	if netstat -nltp|grep 'dropbear' 1>/dev/null 2>/dev/null;then
		...
		echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mCHANGE DROPBEAR DOOR\033[0m"
		...
		if [[ "$resposta" = '1' ]]; then
			...
			if ps x | grep "limiter"|grep -v grep 1>/dev/null 2>/dev/null; then
				...
				echo ""
				fun_bar 'screen -d -m -t limit drop limit' 'sleep 3'
			...
			echo ""
			echo -ne "\033[1;32mWHICH DOOR YOU WANT TO USE \033[1;33m?\033[1;37m "; read pt
			echo ""
			verif_ptrs $pt
			var1=$(sed -n '6 p' /etc/default/dropbear)
			echo -e "\033[1;32mCHANGING DROPBEAR DOOR!"
			...
			echo -e "\n\033[1;32mSUCCESSFULLY CHANGED DOOR!"
			sleep 3
			clear
			fun_conexao
		...
		if [[ "$resposta" = 's' ]]; then
			...
			echo -ne "\033[1;32mWHAT DOOR \033[1;33m?\033[1;37m "; read porta
			if [[ -z "$porta" ]]; then
				echo -e "\n\033[1;31mInvalid door!"
				sleep 3
				clear
...
if netstat -nltp|grep 'stunnel4' 1>/dev/null 2>/dev/null;then
    ...
    echo -e "\n\033[1;33mDOORS\033[1;37m: \033[1;32m$sslt"
    echo ""
    ...
    echo ""
    if [[ "$resposta" = '1' ]]; then
    echo -ne "\033[1;32mWHICH DOOR YOU WANT TO USE \033[1;33m?\033[1;37m "; read porta
    echo ""
	if [[ -z "$porta" ]]; then
		echo ""
		echo -e "\033[1;31mInvalid door!"
		sleep 3
		clear
		fun_conexao		
	fi
	verif_ptrs $porta
	echo -e "\033[1;32mALTERING TUNNEL SSL PORT!"
	...
	echo ""
	netstat -nltp|grep 'stunnel4' > /dev/null && echo -e "\033[1;32mSUCCESSFULLY CHANGED DOOR!" || echo -e "\033[1;31mUNEXPECTED ERROR!"
	sleep 3.5s
	clear
	fun_conexao
	fi
    ...
    echo -e "\n\033[1;32mSSL TUNNEL SUCCESSFULLY INSTALLED!\033[1;31m DOOR: \033[1;33m$porta\033[0m"
    sleep 3
    clear
    fun_conexao
    else
...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	do
		...
		echo ""
		echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33mCHANGE DOOR"
		...
		case $option in
			1) 
			clear
			echo -e "\E[44;1;37m         CHANGE OPENVPN DOOR         \E[0m"
			echo ""
			echo -e "\033[1;33mDOOR IN USE: \033[1;32m$opnp"
			echo ""
			echo -ne "\033[1;32mWHICH DOOR YOU WISH TO USE \033[1;33m?\033[1;37m "; read porta
			if [[ -z "$porta" ]]; then
				echo ""
				echo -e "\033[1;31mInvalid door!"
				sleep 3
		    ...
		    fun_bar 'fun_opn'
		    echo ""
		    echo -e "\033[1;32mDOOR CHANGED SUCCESSFULLY!\033[1;33m"
		    sleep 3
		    fun_conexao
			;;
			2) 
			echo ""
			echo -ne "\033[1;32mWISH TO REMOVE OPENVPN \033[1;31m? \033[1;33m[s/n]:\033[1;37m "; read REMOVE
			if [[ "$REMOVE" = 's' ]]; then
				rmv_open () {
			...
			if [[ "$resp" = '1' ]]; then
				...
				echo ""
				echo -e "\E[44;1;37m      Host successfully added!     \E[0m"
			    sleep 2
			    fun_openvpn
			elif [[ "$resp" = '2' ]]; then
				clear
	...
	echo ""
	read -p "$(echo -e "\033[1;32mWHICH DOOR YOU WISH TO USE? \033[1;37m")" -e -i 1194 porta
	if [[ -z "$porta" ]]; then
				echo ""
				echo -e "\033[1;31mInvalid door!"
				sleep 3
	...
	echo ""
	echo -e "\033[1;33mCHECKING DOOR..."
	sleep 2
	verif_ptrs $porta
	echo ""
	echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;33mSystem"
	echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;33mGoogle (\033[1;32mRrecommended\033[1;33m)"
...
fun_socks () {
    ...
    [[ $(netstat -nplt |grep 'python' | wc -l) != '0' ]] && {
        ...
        echo -e "\033[1;33mDOORS\033[1;37m: \033[1;32m$(netstat -nplt |grep 'python' | awk {'print $4'} |cut -d: -f2 |xargs)"
    } || {
	...
	echo -e "\033[1;31m[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mOPEN THE DOOR\033[0m"
	...
	if [[ "$resposta" = '1' ]]; then
		...
		if ps x | grep proxy.py|grep -v grep 1>/dev/null 2>/dev/null; then
			...
			echo -e "\E[44;1;37m            PROXY SOCKS             \E[0m"
			echo ""
			echo -e "\033[1;33mDOORS IN USE: \033[1;32m$sockspt"
			echo ""
			echo -ne "\033[1;32mWHICH DOOR YOU WANT TO USE \033[1;33m?\033[1;37m: "; read porta
			if [[ -z "$porta" ]]; then
				echo ""
			...
			verif_ptrs $porta
			echo ""
			echo -e "\033[1;32mSTARTING PROXY SOCKS AT THE DOOR \033[1;31m$porta\033[1;33m"
			echo ""
			abrirptsks () {
				sleep 1
				screen -dmS proxy python /etc/SSHPlus/proxy.py $porta
		...
		if ps x | grep proxy.py|grep -v grep 1>/dev/null 2>/dev/null; then
			...
			if [[ -z "$msgg" ]]; then
				echo ""
				echo -e "\033[1;31mInvalid status!"
				sleep 3
				fun_conexao
			fi
...
fun_openssh () {
	...
	echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;37m• \033[1;33mADD DOOR\033[1;31m
[\033[1;36m2\033[1;31m] \033[1;37m• \033[1;33mREMOVE DOOR\033[1;31m
[\033[1;36m3\033[1;31m] \033[1;37m• \033[1;33mCOME BACK\033[0m"
	...
	if [[ "$resp" = '1' ]]; then
		...
		verif_ptrs $pt
		echo -e "\n\033[1;32mADICTIONING DOOR TO SSH\033[0m"
		echo ""
		fun_addpssh () {
		...
		fun_bar 'fun_addpssh'
		echo -e "\n\033[1;32mSUCCESSFULLY ADDED DOOR\033[0m"
		sleep 3
		fun_conexao
	elif [[ "$resp" = '2' ]]; then
		clear
		echo -e "\E[41;1;37m         REMOVE SSH PORT         \E[0m"
		echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mSTANDARD DOOR \033[1;37m22 \033[1;33mWATCH OUT !\033[0m"
		echo -e "\n\033[1;33mDOORS IN USE: \033[1;37m$(grep 'Port' /etc/ssh/sshd_config|cut -d' ' -f2 |grep -v 'no' |xargs)\n"
		echo -ne "\033[1;32mWHICH DOOR YOU WISH TO REMOVE \033[1;33m?\033[1;37m "; read pt
		if [[ -z "$pt" ]]; then
			echo -e "\n\033[1;31mInvalid door!"
			sleep 3
		...
		[[ $(grep -wc "$pt" '/etc/ssh/sshd_config') != '0' ]] && {
			...
			fun_bar 'fun_delpssh'
			echo -e "\n\033[1;32mSUCCESSFULLY REMOVED DOOR\033[0m"
			sleep 3
			fun_conexao
		} || {
			echo -e "\n\033[1;31mInvalid door!"
...
fun_sslh () {
 [[ "$(netstat -nltp|grep 'sslh' |wc -l)" = '0' ]] && {
    ...
    echo -e "\n\033[1;33m[\033[1;31m!\033[1;33m] \033[1;32mA DOOR \033[1;37m443 \033[1;32mWILL BE USED BY STANDARD\033[0m\n"
...
echo -e "\033[1;32mSERVICE: \033[1;33mOPENSSH \033[1;32mDOOR: \033[1;37m$(grep 'Port' /etc/ssh/sshd_config|cut -d' ' -f2 |grep -v 'no' |xargs)" && sts6="\033[1;32m◉ "

[[ "$(netstat -nltp|grep 'sslh' |wc -l)" != '0' ]] && {
	echo -e "\033[1;32mSERVICE: \033[1;33mSSLH: \033[1;32mDOOR: \033[1;37m$(netstat -nplt |grep 'sslh' |awk {'print $4'} |cut -d: -f2 |xargs)"
	sts7="\033[1;32m◉ "
} || {
	sts7="\033[1;31m○ "
}
...
[[ "$(netstat -nplt |grep 'openvpn' |wc -l)" != '0' ]] && {
	echo -e "\033[1;32mSERVICE: \033[1;33mOPENVPN: \033[1;32mDOOR: \033[1;37m$(netstat -nplt |grep 'openvpn' |awk {'print $4'} |cut -d: -f2 |xargs)"
	sts5="\033[1;32m◉ "
} || {
	sts5="\033[1;31m○ "
}
...
[[ "$(netstat -nplt |grep 'python' |wc -l)" != '0' ]] && {
	echo -e "\033[1;32mSERVICE: \033[1;33mPROXY SOCKS \033[1;32mDOOR: \033[1;37m$(netstat -nplt |grep 'python' | awk {'print $4'} |cut -d: -f2 |xargs)"
	sts4="\033[1;32m◉ "
} || {
	sts4="\033[1;31m○ "
}
[[ -e "/etc/stunnel/stunnel.conf" ]] && {
	echo -e "\033[1;32mSERVICE: \033[1;33mSSL TUNNEL \033[1;32mDOOR: \033[1;37m$(netstat -nplt |grep 'stunnel' | awk {'print $4'} |cut -d: -f2 |xargs)"
	sts3="\033[1;32m◉ "
} || {
	sts3="\033[1;31m○ "
}
[[ "$(netstat -nltp|grep 'dropbear' |wc -l)" != '0' ]] && {
	echo -e "\033[1;32mSERVICE: \033[1;33mDROPBEAR \033[1;32mDOOR: \033[1;37m$(netstat -nplt |grep 'dropbear' | awk -F ":" {'print $4'} | xargs)"
	sts2="\033[1;32m◉ "
} || {
	sts2="\033[1;31m○ "
}
[[ "$(netstat -nplt |grep 'squid'| wc -l)" != '0' ]] && {
	echo -e "\033[1;32mSERVICE: \033[1;33mSQUID \033[1;32mDOOR: \033[1;37m$(netstat -nplt |grep 'squid' | awk -F ":" {'print $4'} | xargs)"
	sts1="\033[1;32m◉ "
} || {
	sts1="\033[1;31m○ "
}
