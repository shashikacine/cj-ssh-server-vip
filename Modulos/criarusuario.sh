...
fun_edithost () {
  ...
  echo -e "\033[1;31m[\033[1;36m3\033[1;31m] \033[1;33mI LIVE MMS \033[1;31m[\033[1;37mAPN: \033[1;32mmms.vivo.com.br\033[1;31m]"
  echo -e "\033[1;31m[\033[1;36m4\033[1;31m] \033[1;33mHOST OI 4G \033[1;31m[\033[1;32mSome Regions\033[1;31m]"
  echo -e "\033[1;31m[\033[1;36m5\033[1;31m] \033[1;33mMODO BYPASS\033[1;31m[\033[1;32mopen + http injector\033[1;31m]"
  echo -e "\033[1;31m[\033[1;36m6\033[1;31m] \033[1;33mALL HOSTS \033[1;31m[\033[1;32m1 Ovpn of each\033[1;31m]" 
  echo -e "\033[1;31m[\033[1;36m7\033[1;31m] \033[1;33mEDIT MANUALLY"
  echo -e "\033[1;31m[\033[1;36m0\033[1;31m] \033[1;33mCOME BACK"
  echo ""
  echo -ne "\033[1;32mWHICH HOST WANTS TO USE \033[1;33m?\033[1;37m "; read respo
  if [[ -z "$respo" ]]; then
    echo ""
  ...
  if [[ "$respo" = '1' ]]; then
    ...
    fun_bar 'fun_althost'
    echo ""
    echo -e "\033[1;32mHOST CHANGED SUCCESSFULLY!\033[0m"
    fun_geraovpn
    sleep 1.5
  elif [[ "$respo" = '2' ]]; then
    echo ""
          ...
          then
            ...
            then
              ...
              exit 1
                ...
                echo -ne "\033[1;32mDays to Exhale:\033[1;37m "; read dias
                        ...
                        then
                          ...
                          if [[ -e /etc/openvpn/server.conf ]]; then
                              ...
                              if [[ "$resp" = @(s|S) ]]; then
                                ...
                                [ $? -eq 0 ] && tput setaf 2 ; tput bold ; echo ""; echo -e "\033[1;32mIP: \033[1;37m$IP" ; echo -e "\033[1;32mUser: \033[1;37m$username" ; echo -e "\033[1;32mpassword: \033[1;37m$password" ; echo -e "\033[1;32mExpires in: \033[1;37m$gui" ; echo -e "\033[1;32mConnection limit: \033[1;37m$sshlimiter" ; echo "" || echo "The user could not be created!" ; tput sgr0
                                sleep 1
                                function aguarde {
                                  helice () {
