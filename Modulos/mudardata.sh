...
then
	...
	then
		...
		then
			...
			then
				echo ""
				tput setaf 7 ; tput setab 1 ; tput bold ;	echo "You entered an invalid or non-existent date!" ; echo "Enter a valid date in DAY / MONTH / YEAR format " ; echo "For example: 21/04/2018" ; tput sgr0 ; tput sgr0
				echo ""
				exit 1	
			else
				...
				then
					...
					then
						echo ""
						tput setaf 7 ; tput setab 1 ; tput bold ;	echo "You entered a past date or the current day!" ; echo "Enter a future and valid date in DAY / MONTH / YEAR format" ; echo "For example: 21/04/2018" ; tput sgr0
						echo ""
						exit 1
					else
						chage -E $sysdate $usuario
						echo ""
						tput setaf 7 ; tput setab 4 ; tput bold ; echo "User Success $usuario new data: $udata " ; tput sgr0
						echo ""
						exit 1
					fi
				else
					echo ""
					tput setaf 7 ; tput setab 1 ; tput bold ;	echo "You entered an invalid or non-existent date!" ; echo "Enter a valid date in DAY / MONTH / YEAR format" ; echo "For example: 21/04/2018" ; tput sgr0
					echo ""
					exit 1
				fi
			fi
