...
ajuda ()
{
    if [[ "${message_from_id[$id]}" = "$id_admin" ]]; then
        local env_msg
        env_msg="=×=×=×=×=×=×=×=×=×=×=×=×=×=\n"
        env_msg+="<b>WELCOME TO BOT SSHPLUS</b>\n"
        env_msg+="=×=×=×=×=×=×=×=×=×=×=×=×=×=\n\n"
        ...
        local env_msg1
        env_msg1="=×=×=×=×=×=×=×=×=×=×=×=×=×=\n"
        env_msg1+="<b> WELCOME TO SSHPLUS BOT</b>\n"
        env_msg1+="=×=×=×=×=×=×=×=×=×=×=×=×=×=\n\n"
...
fun_revenda() {
    ...
    env_msg1+="[<b>03</b>] /limite_revenda = Amends\n"
    env_msg1+="[<b>04</b>] /data_revenda = Amends\n"
    env_msg1+="[<b>05</b>] /listar_revenda = Exhibition\n"
...
fun_ajuda() {
    if [[ "${message_from_id[$id]}" = "$id_admin" ]]; then
        ...
        env_msg+="<b>1</b> /criarusuario - <code>create ssh user</code>\n\n"
        env_msg+="<b>2</b> /remover - <code>Remove ssh user</code>\n\n"
        env_msg+="<b>3</b> /infousers - <code>Displays user information</code>\n\n"
        env_msg+="<b>4</b> /monitor - <code>Display users online</code>\n\n"
        env_msg+="<b>5</b> /infovps - <code>Displays vps information</code>\n\n"
        env_msg+="<b>6</b> /alterarsenha - <code>Change user password</code>\n\n"
        env_msg+="<b>7</b> /alterarlimite - <code>Alter the user limit</code>\n\n"
        env_msg+="<b>8</b> /alterardata - <code>Alter the user date</code>\n\n"
        env_msg+="<b>9</b> /backup - <code>Create user backup</code>\n\n"
        env_msg+="<b>10</b> /otimizar - <code>Clear cache and optimize vps </code>\n\n"
        env_msg+="<b>11</b> /speedtest - <code>Run vps speed test</code>\n\n"
        env_msg+="<b>12</b> /arquivos - <code>Hosts files (Ex: ehi, kpn and etc)</code>\n\n"
        env_msg+="<b>13</b> /revenda - <code>Displays resale management menu</code>\n\n"
        env_msg+="<b>14</b> /add_revenda - <code>Add resellerr</code>\n\n"
        env_msg+="<b>15</b> /del_revenda - <code>Remove dealer</code>\n\n"
        env_msg+="<b>16</b> /limite_revenda - <code>Change reseller limit</code>\n\n"
        env_msg+="<b>17</b> /data_revenda - <code>Change reseller date and reactivate when suspended</code>\n\n"
        env_msg+="<b>18</b> /listar_revenda - <code>Displays active and suspended resellers</code>\n\n"
        env_msg+="<b>19</b> /suspender - <code>Suspend reseller and the accounts created by him</code>\n\n"
        env_msg+="<b>20</b> /relatorio - <code>Displays reseller report</code>\n\n"
        env_msg+="<b>21</b> /criarteste - <code>Raise temporary random ssh user</code>\n\n"
        env_msg+="<b>22</b> /expirados - <code>Remove expired users</code>\n\n"
        env_msg+="<b>23</b> /autobackup - <code>Enable automatic backup</code>\n\n"
        env_msg+="<b>24</b> /sobre - <code>credits / information</code>\n\n"
        ...
        env_msg+="<b>6</b> /alterarsenha - <code>Change user password</code>\n\n"
        env_msg+="<b>7</b> /alterarlimite - <code>Alter the user limit</code>\n\n"
        env_msg+="<b>8</b> /criarteste - <code>Raise temporary random ssh user</code>\n\n"
        env_msg+="<b>9</b> /expirados - <code>Remove expired users</code>\n\n"
        env_msg+="<b>10</b> /relatorio - <code>Displays Information</code>\n\n"
        env_msg+="<b>11</b> /alterardata - <code>Remove ssh user</code>\n\n"
        env_msg+="<b>12</b> /sobre - <code>credits / information</code>\n\n"
        ShellBot.sendMessage --chat_id ${message_chat_id[$id]} \
            --text "$(echo -e $env_msg)" \
            --parse_mode html
        return 0
