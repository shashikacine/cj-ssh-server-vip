...
read -p "$(echo -e "\033[1;32mDO YOU WANT TO REMOVE FIREWALL RULES? \033[1;33m[s/n]:\033[1;37m") " -e -i n resp
if [[ "$resp" = 's' ]]; then
	echo ""	
	fun_spn1
	echo ""
...
echo ""
read -p "$(echo -ne "\033[1;32mYOU WANT TO APPLY FIREWALL RULES ? \033[1;33m[s/n]:\033[1;37m") " -e -i n resp
if [[ "$resp" = 's' ]]; then
echo ""
...
echo ""
echo -e "\033[1;32mSUCCESSFULLY APPLIED FIREWALL !"
sleep 3
menu
else
	sleep 1
